...
__MODULE__ = "𝚅𝙴𝚁𝚁𝙽𝙾𝚇𝚉 𝙰𝙸"
__HELP__ = """
<blockquote><b>Bantuan Untuk VerrNoxz-ai

perintah : <code>{0}verrai</code>
...
async def chat_gpt(client, message):
    try:
        ...
        if len(message.command) < 2:
            ...
            prs = await message.reply_text(f"<emoji id=5319230516929502602>🔍</emoji>proccesing verrai....")
