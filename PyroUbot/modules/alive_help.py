...
<blockquote>{bot.me.mention}
    status: {status} 
       {psr} expired_on: {exp} 
        ...
        <blockquote><b>USERBOT 5K/BULAN BY @Userbot_buy_bot</b></blockquote>
"""
...
async def _(client, callback_query):
    ...
    os.execl(sys.executable, sys.executable, "-m", "𝘚𝘢𝘵𝘢𝘯𝘪𝘹𝘤𝘢𝘓 𝘜𝘣𝘰𝘵 𝘗𝘳𝘦𝘮")
